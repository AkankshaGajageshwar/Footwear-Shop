...
export default function AddProduct() {
  ...
  const Validate = (values) => {
    ...
    if (!values.title) {
      ...
      errors.title = "Title is too short, atleast 3 characters required ..!"
    }
    if (!values.category) {
    ...
    if (!values.image) {
      errors.image = "Image must be required !!!"
    }
    if (!values.color) {
  ...
  function handleSubmit(e) {
    ...
    // console.log(data);
    if (id === undefined) {
      axios.post("https://664469426c6a6565870a48dd.mockapi.io/footwear/", data)
        .then((res) => {
      ...
      axios.put("https://664469426c6a6565870a48dd.mockapi.io/footwear/" + id, data)
        .then((res) => {
          console.log(res.data);
          // loadData();
          setData({
      ...
      <div className="container">
          ...
          <div className="col-lg-6">
            <form action="" onSubmit={handleSubmit}>
              <div class="mb-2">
                ...
                <input required type="text" class="form-control border border-dark" aria-describedby="emailHelp" id='title' value={data.title} onChange={handleChange} />
              </div>
        ...
        <div className="row">
          <div className="col-lg-10">
            ...
            <button onClick={(e) => handleSubmit(e)} className='btn' style={{ backgroundColor: "rgb(136, 200, 188)", color: "black" }}>
              Submit
            </button>
          </div>
        </div>
